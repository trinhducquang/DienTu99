...
public class ThemeManager {
    ...
    private static final String LIGHT_THEME = "/org/example/dientu99/views/css/light_Mode.css";
    private static final String DARK_THEME = "/org/example/dientu99/views/css/dark_Mode.css";
