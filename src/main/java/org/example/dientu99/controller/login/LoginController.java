package org.example.dientu99.controller.login;
...
import org.example.dientu99.security.auth.AuthService;
...
public class LoginController {
    ...
    private void updateThemeIcon() {
        ...
        if (ThemeManager.isDarkMode()) {
            iconPath = "/org/example/dientu99/images/light.png";
        } else {
            iconPath = "/org/example/dientu99/images/dark.png";
        }
    ...
    private void changeScene(String fxmlFile) {
        try {
            String fxmlPath = "/org/example/dientu99/views/" + fxmlFile;
